...
def main():
    ...
    calculate_metrics_for_val_metabolites(model, unique_metabolites, metabolite_names, gene_sequences_padded, smiles_features_padded, relationships, device, genes_to_exclude)
